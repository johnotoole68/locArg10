...
print "Observaciones:", wscdc.Obs
    ...
    def do_pyafipws_request_cae(self):
        ...
        for inv in self:
            ...
            if (inv.journal_document_type_id.sequence_id.number_next_actual - 1) != ws_next_invoice_number:
                raise UserError(_(
                    'Error!'
                    'Invoice id: %i'
                    'Next invoice number should be %i and not %i' % (
                        ...
                        inv.journal_document_type_id.sequence_id.number_next_actual-1)))
            ...
            cbt_desde = cbt_hasta = cbte_nro = inv.journal_document_type_id.sequence_id.number_next_actual - 1
